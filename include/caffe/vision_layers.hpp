...
class CAFFE_API_ BaseConvolutionLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_API_ ConvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
  /**
 ...
 */
template <typename Dtype>
class CAFFE_API_ DeconvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
...
*/
template <typename Dtype>
class CAFFE_API_ CuDNNConvolutionLayer : public ConvolutionLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_API_ Im2colLayer : public Layer<Dtype> {
 public:
...
template <typename Dtype> class CAFFE_API_ PoolingLayer;
template <typename Dtype> class CAFFE_API_ SplitLayer;
 ...
 */
template <typename Dtype>
class CAFFE_API_ LRNLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_API_ PoolingLayer : public Layer<Dtype> {
 public:
...
*/
template <typename Dtype>
class CAFFE_API_ CuDNNPoolingLayer : public PoolingLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_API_ SPPLayer : public Layer<Dtype> {
 public:
...
template <typename Dtype>
class CAFFE_API_ UpsampleLayer : public Layer<Dtype> {
 public:
